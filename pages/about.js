    ...
    return (
        <div className="app">
            ...
            <div className="about-card">
                ...
                <p>Some of my interests: I enjoy building and programming mechanical keyboards. I love science (astronomy, paleoanthropology, & evolution) as well as philosophy (ancient Greek & Roman Stoicism). My motivation for success is my family, I am married and have two daughters (4 & 6). There is nothing I enjoy more than being a parent. My passion and resilience for being a successful developer stems from my girls.</p>
            </div>
